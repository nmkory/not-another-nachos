...
public class PriorityScheduler extends Scheduler {
	...
	protected class ThreadState {
		...
		/**
		 * Recursively updates the effective priority of a ThreadState for its own
		 * priority and for any of the resource owners for resources it is currently
		 * waiting on. Only updates if it should be updated.
		 *
