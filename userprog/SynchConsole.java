...
public class SynchConsole {
	 ...
	 * <tt>255</tt>). If a byte has not arrived at, blocks until a byte arrives, or
	 * returns immediately, depending on the value of <i>block</i>.
	 *
	 * @param block <tt>true</tt> if <tt>readByte()</tt> should wait for a byte if
	 *              none is available.
	 * @return the next byte read, or -1 if <tt>block</tt> was <tt>false</tt> and no
	 *         byte was available.
	 */
